    ...
    <>
      ...
      >
        ...
        {isHamopen && (
          <>
            ...
            <Link href="/dashboard" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">Dashboard</Link>
            <Link href="/user-profile" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">User Profile</Link>
              <Link href="/create-new-rent" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">Create New Rent</Link>
              <Link href="/all-properties" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">All Properties</Link>
              <Link href="/add-maintanence" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">Add Maintenance</Link>
              <Link href="/add-expense" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">Add Expense</Link>
              <Link href="/revenue" className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-80">Revenue</Link>
              <div
      ...
      >
        <div className="w-full h-1/2 bg-[#DDA15E] hover:bg-opacity-80 rounded-md bg-opacity-50 flex justify-center items-center cursor-pointer">
          <div className="transition-all ease-in-out  duration-500" style={{ display: `${isopenUserProfile ? 'flex' : 'none'}`, fontSize: `${isopenUserProfile ? '16px' : '0px'}`  }}>User Profile</div>
        </div>
        <div className="w-full h-1/2 bg-black rounded-md flex justify-center items-center cursor-pointer" onClick={logout}>
          <Image src="/logoutIconWhite.png" width={20} height={20} alt="Logout" />
