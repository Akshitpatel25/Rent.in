...
export default function Navbar({ Nav_user }: any) {
  ...
  return (
    <>
      {/* Navbar */}
      <div className="w-full h-full pl-2 pr-2 border border-black border-opacity-10 flex justify-between items-center">
        {/* Hamburger Bar */}
        <div
        ...
        {isHamopen && (
          <>
            ...
            <nav className="w-full flex flex-col gap-y-2">
              <Link
                href="/dashboard"
                className="p-2 bg-white bg-opacity-40 rounded-md text-center md:text-xl hover:bg-opacity-70 transition-all ease-in-out"
              >
                Dashboard
              </Link>
              <Link
              ...
              <div
                className="p-2 bg-black text-white bg-opacity-60 rounded-md text-center md:text-xl cursor-pointer hover:bg-opacity-70 transition-all ease-in-out"
                onClick={logout}
              >
                Logout
              </div>
